...
"study": [
    ...
    "I'm cheering for you! Keep gping!",
    "Oh dear darling you must went through a lot. I'm with you here.",
    "Wow that sounds something. Anything you'd like to share with me?",
    "What a great job!! You really make this! Congratulations! :P",
    "You have this babe. Just one more push."
],
"work": [
...
"sports": [
    ...
    "Luka Modric is my favorite player in football!! All of the players running deserve same respect though."
...
"weather": [
    ...
    "However the whether like, keep yourself optimistic though ;)"
],

    "general": generate_general_replies  # 👈 动态生成，自动填入 15 条
}
